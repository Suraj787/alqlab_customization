...
# class PurchasingInvoice(Document):
# 	pass

class PurchasingInvoice(BuyingController):
	def __init__(self, *args, **kwargs):
		super(PurchasingInvoice, self).__init__(*args, **kwargs)
		self.status_updater = [{
	...
	def onload(self):
		super(PurchasingInvoice, self).onload()
	...
	def validate(self):
		...
		super(PurchasingInvoice, self).validate()
	...
	def validate_with_previous_doc(self):
		super(PurchasingInvoice, self).validate_with_previous_doc({
			"Purchase Order": {
	...
	def validate_warehouse(self):
		...
		super(PurchasingInvoice, self).validate_warehouse()
	...
	def on_submit(self):
		super(PurchasingInvoice, self).on_submit()
	...
	def on_cancel(self):
		super(PurchasingInvoice, self).on_cancel()
